            ...
            <div class="space-y-4">
                @foreach ($analyses as $analysis)
                    @php
                        ...
                        $hackernews = array_slice($rawData['hackernews'] ?? [], 0, 5);
                    ...
                    <div x-data="{ open: {{ $loop->first ? 'true' : 'false' }} }"
                        ...
                        <div class="mb-3 flex flex-wrap items-start justify-between gap-2">
                            <button @click="open = !open" class="flex min-w-0 flex-1 items-center gap-2 text-left">
                                ...
                                @endif
                                <h3 class="flex-1 font-semibold text-gray-900 dark:text-white">{{ $analysis->topic }}
                                </h3>
                            ...
                            <div class="flex shrink-0 items-center gap-2">
                                ...
                                @if ($isFailed)
                                    <button wire:click="deleteAnalysis({{ $analysis->id }})"
                                        wire:confirm="{{ __('leads.trend_analysis_delete_confirm') }}"
                                        ...
                                        title="{{ __('leads.trend_analysis_delete') }}">
