<div class="space-y-6">
    ...
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-gray-700">
            ...
            <span class="rounded-full px-2 py-0.5 text-xs font-semibold
                {{ $thread->status === 'replied' ? 'bg-yellow-100 text-yellow-700' :
                   ($thread->status === 'closed' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700') }}">
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div class="px-4 py-3 {{ $message->role === 'outbound' ? 'bg-primary-50 dark:bg-primary-900/10' : '' }}">
                ...
                @if ($message->subject)
                <p class="mb-1 text-sm font-semibold text-gray-800 dark:text-white">{{ $message->subject }}</p>
                @endif
    ...
    <div class="rounded-xl border border-yellow-300 bg-yellow-50 p-4 shadow-sm dark:border-yellow-700 dark:bg-yellow-900/20">
